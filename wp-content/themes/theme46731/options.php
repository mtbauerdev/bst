...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '19px', 'face' => 'Tahoma, Geneva, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#887f76'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '32px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#fefefe'));
			
			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '26px', 'lineheight' => '31px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#fefefe'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '29px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#fefefe'));
			
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '24px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#fefefe'));
								
			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '26px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#fefefe'));
								
			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '16px', 'lineheight' => '19px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#fefefe'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '26px', 'lineheight' => '31px', 'face' => 'Sonsie One', 'style' => 'normal', 'character'  => 'latin', 'color' => '#c39c38'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '16px', 'lineheight' => '19px', 'face' => 'Sonsie One', 'style' => 'normal', 'character'  => 'latin', 'color' => '#82623e'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '14px', 'lineheight' => '17px', 'face' => '"Trebuchet MS", Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
